...
if x > y:
    print(str(x) + " is grather than" + str(y))
else:
...
#careful with return values, if both are true it will return the first value
x = 10 
y = 100
...
# you cant reassign, this will error
# True = 1
# False = 0